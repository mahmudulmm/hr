        ...
        <div class="container-fluid">
            ...
            <div class="navbar-left">
                <div class="navbar-btn">
                    <a href="index.html"><img src="{{asset('/dashboard_assets')}}/images/icon.svg" alt="Oculux Logo" class="img-fluid logo"></a>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li>
                          ...
                          <form method="POST" action="{{ route('logout') }}">
                             ...
                             <span class="material-symbols-outlined icon-power" :href="route('logout')"
